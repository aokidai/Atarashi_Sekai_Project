<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ムービー-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx.cs" Inherits="NewWordProject.Film.ムービー_TVアニメ_新しいセカイプロジェクト_公式サイト" %>
...
<head runat="server">
    ...
    <title>ムービー-TVアニメ「新しいセカイプロジェクト」公式サイト</title>
...
<body id="body">
    <form id="form1" runat="server">
        ...
        <div id="myNav" class="overlay">
            ...
            <div class="overlay-content">
                ...
                <a href="./ムービー-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx"><span id="menu">ムービー</span></a>
    ...
    <section id="ss">
        <aside>
            <div>
                <div id="title" align="center"><span id="ttstyle">ムービー</span></div>
            </div>
