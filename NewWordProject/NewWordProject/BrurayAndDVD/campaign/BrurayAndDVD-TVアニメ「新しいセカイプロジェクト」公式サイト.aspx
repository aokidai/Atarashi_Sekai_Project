                        ...
                        <div id="menu_ss1">
                            <table align="center">
                                <tr>
                                    ...
                                    <td>
                                        <div class="combobox">
                                            <a href="./BrurayAndDVD-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx">キャンペーン</a>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div id="menu_ss2" align="center">
                            <div>
                                ...
                                <div>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:conn %>" SelectCommand="br4" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                                </div>
                            </div>
