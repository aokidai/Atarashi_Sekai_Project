                        ...
                        <div id="menu_ss1">
                            <table align="center">
                                <tr>
                                    ...
                                    <td>
                                        <div class="combobox">
                                            <a href="./BrurayAndDVD-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx">店舗別特典</a>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="combobox2">
                        ...
                        <div id="menu_ss2" align="center">
                            <div>
                                ...
                                <div>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:conn %>" SelectCommand="br5" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                                </div>
                            </div>
