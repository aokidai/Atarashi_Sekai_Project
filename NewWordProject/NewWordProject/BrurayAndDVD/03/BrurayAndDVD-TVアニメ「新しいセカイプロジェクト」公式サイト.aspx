                ...
                <div id="nana">
                    <div>
                        <div id="menu_ss1">
                            <table align="center">
                                <tr>
                                    ...
                                    <td>
                                        <div class="combobox">
                                            <a href="./BrurayAndDVD-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx">第3巻</a>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="combobox2">
                        ...
                        <div id="menu_ss2" align="center">
                            <div>
                                <div class="box">
                                    <span class="title2">セカイ3―第3巻</span>
                                </div>
                                <div>
                                    <!--Naiyo-->
                                    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" RepeatLayout="Flow">
                                        <ItemTemplate>
                                            ...
                                            <br />
                                            <asp:Image ID="Image1" runat="server" ImageUrl='<%# "~/BrurayAndDVD/03/images/"+Eval("images") %>' />
                                            <br />
                                        </ItemTemplate>
                                    </asp:DataList>
