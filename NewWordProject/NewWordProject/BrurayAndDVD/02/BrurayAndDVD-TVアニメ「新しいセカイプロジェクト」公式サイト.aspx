<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrurayAndDVD-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx.cs" Inherits="NewWordProject.BrurayAndDVD._01.BrurayAndDVD_TVアニメ_新しいセカイプロジェクト_公式サイト" %>
...
<body id="body">
    <form id="form1" runat="server">
        ...
        <div id="myNav" class="overlay">
            ...
            <div class="overlay-content">
                ...
                <a href="../01/BrurayAndDVD-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx"><span id="menu">Blu-ray&DVD</span></a>
    ...
    <section id="ss">
        <aside>
            <div>
                <div id="title" align="center"><span id="ttstyle">Bru-ray & DVD</span></div>
            </div>
                ...
                <div id="nana">
                    <div>
                        <div id="menu_ss1">
                            <table align="center">
                                <tr>
                                    <td>
                                        <div class="combobox2">
                                            <a href="../01/BrurayAndDVD-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx">第1巻</a>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="combobox">
                                            <a href="./BrurayAndDVD-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx">第2巻</a>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="combobox2">
                                            <a href="../03/BrurayAndDVD-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx">第3巻</a>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="combobox2">
                                            <a href="../privilege/BrurayAndDVD-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx">店舗別特典</a>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="combobox2">
                                            <a href="../campaign/BrurayAndDVD-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx">キャンペーン</a>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div id="menu_ss2" align="center">
                            <div>
                                <div class="box">
                                    <span class="title2">セカイ2―第2巻</span>
                                </div>
                                <div>
                                    <!--Naiyo-->
                                    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" RepeatLayout="Flow">
                                        <ItemTemplate>
                                            ...
                                            <br />
                                            <asp:Image ID="Image1" runat="server" ImageUrl='<%# "~/BrurayAndDVD/02/images/"+Eval("images") %>' />
                                            <br />
                                        </ItemTemplate>
                                    </asp:DataList>
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:conn %>" SelectCommand="br2" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                                </div>
                            </div>
