<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="グッズ-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx.cs" Inherits="NewWordProject.Goods.WebForm1" %>
...
<head runat="server">
    ...
    <title>グッズ-TVアニメ「新しいセカイプロジェクト」公式サイト</title>
...
<body id="body">
    <form id="form1" runat="server">
        ...
        <div id="myNav" class="overlay">
            ...
            <div class="overlay-content">
                ...
                <a href="./グッズ-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx"><span id="menu">グッズ</span></a>
    ...
    <section id="ss">
        <aside>
            <div>
                <div id="title" align="center"><span id="ttstyle">グッズ</span></div>
            </div>
                    ...
                    <div>
                        <div id="menu_ss1">
                            ...
                            <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink2" runat="server" ImageUrl='<%# "~/Goods/images/"+Eval("images") %>' NavigateUrl='<%# Eval("link", "{0}") %>'>[HyperLink2]</asp:HyperLink>
                                    <br />
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:conn %>" SelectCommand="SELECT [images], [link], [gName] FROM [Goods]"></asp:SqlDataSource>
