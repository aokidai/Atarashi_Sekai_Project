        ...
        <aside>
            ...
            <div id="naiyo">
                <div id="setsume" align="center">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:conn %>" SelectCommand="kyan7" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
