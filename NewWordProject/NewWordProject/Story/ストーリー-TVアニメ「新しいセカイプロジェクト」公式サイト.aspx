<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ストーリー-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx.cs" Inherits="NewWordProject.Story.ストーリー_TVアニメ_新しいセカイプロジェクト_公式サイト" %>
        ...
        <aside>
            ...
            <div id="naiyo">
                <div id="menu_ss1">
                    ...
                    <br />
                    <div class="combobox">
                        <a href="./01/ストーリー-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx"><span>#01</span></a>
                    </div>
                    <br />
                </div>
                <div id="menu_ss2">
