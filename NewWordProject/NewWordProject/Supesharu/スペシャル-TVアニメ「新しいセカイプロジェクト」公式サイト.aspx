<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="スペシャル-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx.cs" Inherits="NewWordProject.Supesharu.スペシャル_TVアニメ_新しいセカイプロジェクト_公式サイト" %>
...
<head runat="server">
    ...
    <title>スペシャル-TVアニメ「新しいセカイプロジェクト」公式サイト</title>
...
<body id="body">
    <form id="form1" runat="server">
        ...
        <div id="myNav" class="overlay">
            ...
            <div class="overlay-content">
                ...
                <a href="./スペシャル-TVアニメ「新しいセカイプロジェクト」公式サイト.aspx"><span id="menu">スペシャル</span></a>
            </div>
        </div>
    ...
    <section id="ss">
        <aside>
            <div>
                <div id="title" align="center"><span id="ttstyle">スペシャル</span></div>
            </div>
